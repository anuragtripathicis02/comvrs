  ...
  return (
    <div className='fice-col-box'>
        <div className="head-box w-100 mb-2">
          <p className="m-0 font-w-600 fs-14">Manage Orders</p>
        </div>
        ...
        <div className="header-list-box p-0 mb-2 border-0 radius-0">
            <ul className="p-0 pb-2 min-w-900 m-0 list-unstyled d-flex radius-0  flex-wrap">
                ...
                <li>
                    <Link to="/create-edit-customer" className="small-btn-outline btn-outline fill-btn d-flex align-items-center gap-2 text-nowrap flex-nowrap justify-content-center">
