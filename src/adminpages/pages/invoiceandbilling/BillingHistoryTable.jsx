...
const BillingHistoryTable = () => {
    ...
    return (
        <div className="table-default table-left min-w-1200">
            <Table className="text-center table-hover align-middle m-0 p-0" responsive>
                ...
                <tbody>
                    <tr>
                        <td>
                            <p className='mb-0'>IN-05</p>
                            <span className='green-text'>#1234567890</span>
                        </td>
                        <td>
                            <span className='text-simple'>Jim kelly (12345)</span>
                            <p className='mb-0'>Cysco Consultancy.co</p>
                        </td>
                        <td>
                            <p className='mb-0'>Monthly</p>
                            <p className='mb-0'>Card Pay</p>
                        </td>
                        <td>
                            May 2026
                        </td>
                        ...
                        <td>
                            <button className=' inline-block align-middle red-btn red-text btn-small'>
                    ...
                    <tr>
                       ...
                       <td>
                            <button className=' inline-block yellow-btn yellow-text btn-small'>
