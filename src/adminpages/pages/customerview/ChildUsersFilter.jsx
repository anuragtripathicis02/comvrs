  ...
  return (
        ...
        <div className="header-list-box p-0 mb-2 border-0 radius-0">
            <ul className="p-0 pb-2 min-w-900 m-0 list-unstyled d-flex radius-0  flex-wrap">
                ...
                <li>
                    <button onClick={handleSubUser} className="small-btn-outline btn-outline fill-btn d-flex align-items-center gap-2 text-nowrap flex-nowrap justify-content-center">
...
export default ChildUsersFilter