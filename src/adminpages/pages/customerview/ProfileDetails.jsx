        ...
        <div className='row'>
            <div className='col-md-6'>
                <div className='view-order-left mb-4'>
                    <div className='card-box white-card w-100 fs-14'>
                        ...
                        <div className='list-details'>
                            ...
                            <div className='list-details-card pb-2 d-flex align-items-center gap-3 w-100'>
                                ...
                                <span className='p-0 m-0'>:</span>
                                <p className='p-0 m-0'>Houston</p>
                            </div>
                            <div className='list-details-card pb-2 d-flex align-items-center gap-3 w-100'>
                                <p className='p-0 m-0'>State</p>
                                <span className='p-0 m-0'>:</span>
                                <p className='p-0 m-0'>Taxes</p>
                            </div>
                            <div className='list-details-card pb-2 d-flex align-items-center gap-3 w-100'>
                                <p className='p-0 m-0'>Address</p>
                                <span className='p-0 m-0'>:</span>
                                <p className='p-0 m-0'>1234 Main Street, Apt 100</p>
                            </div>
                            <div className='list-details-card pb-2 d-flex align-items-center gap-3 w-100'>
                                <p className='p-0 m-0'>Zip Code</p>
                                <span className='p-0 m-0'>:</span>
                                <p className='p-0 m-0'>77002</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div className='card-box white-card w-100 fs-14'>
                        ...
                        <div className='list-details'>
                            <div className='list-details-card pb-2 d-flex align-items-center gap-3 w-100'>
                                ...
                                <span className='p-0 m-0'>:</span>
                                <p className='p-0 m-0'>lnelson@levlawllc.com</p>
                                <button className='copy-button bg-transparent'><svg width="20" height="20" viewBox="0 0 20 20" fill="none">
                                    <path d="M16.875 2.5H6.875C6.70924 2.5 6.55027 2.56585 6.43306 2.68306C6.31585 2.80027 6.25 2.95924 6.25 3.125V6.25H3.125C2.95924 6.25 2.80027 6.31585 2.68306 6.43306C2.56585 6.55027 2.5 6.70924 2.5 6.875V16.875C2.5 17.0408 2.56585 17.1997 2.68306 17.3169C2.80027 17.4342 2.95924 17.5 3.125 17.5H13.125C13.2908 17.5 13.4497 17.4342 13.5669 17.3169C13.6842 17.1997 13.75 17.0408 13.75 16.875V13.75H16.875C17.0408 13.75 17.1997 13.6842 17.3169 13.5669C17.4342 13.4497 17.5 13.2908 17.5 13.125V3.125C17.5 2.95924 17.4342 2.80027 17.3169 2.68306C17.1997 2.56585 17.0408 2.5 16.875 2.5ZM12.5 16.25H3.75V7.5H12.5V16.25ZM16.25 12.5H13.75V6.875C13.75 6.70924 13.6842 6.55027 13.5669 6.43306C13.4497 6.31585 13.2908 6.25 13.125 6.25H7.5V3.75H16.25V12.5Z" fill="#8390A2" />
                                </svg>
                                </button>
                            </div>
            ...
            <div className='col-md-6'>
                <div className='view-order-left mb-4'>
                    <div className='card-box white-card w-100 fs-14'>
                        ...
                        <div className='list-details'>
                            <div className='list-details-card pb-2 d-flex align-items-center gap-3 w-100'>
                                <p className='p-0 m-0'>Preference</p>
                                <span className='p-0 m-0'>:</span>
                                <p className='p-0 m-0'>Card Payout</p>
                            </div>
                            <div className='list-details-card pb-2 d-flex align-items-center gap-3 w-100'>
                                <p className='p-0 m-0'>Billing Circle</p>
                                <span className='p-0 m-0'>:</span>
                                <p className='p-0 m-0'>Pre Order Payment</p>
                            </div>
                            <div className='list-details-card pb-2 d-flex align-items-center gap-3 w-100'>
                                <p className='p-0 m-0'>Card Number</p>
                                <span className='p-0 m-0'>:</span>
                                <p className='p-0 m-0'>12** **** **** **34</p>
                            </div>
                            <div className='list-details-card pb-2 d-flex align-items-center gap-3 w-100'>
                                <p className='p-0 m-0'>Card Holder</p>
                                <span className='p-0 m-0'>:</span>
                                <p className='p-0 m-0'>John Smith</p>
                            </div>
                            <div className='list-details-card pb-2 d-flex align-items-center gap-3 w-100'>
                                <p className='p-0 m-0'>Expiry Date</p>
                                <span className='p-0 m-0'>:</span>
                                <p className='p-0 m-0'>02 / 2027</p>
                            </div>
                            <div className='list-details-card pb-2 d-flex align-items-center gap-3 w-100'>
                                <p className='p-0 m-0'>CSV/CVV</p>
                                <span className='p-0 m-0'>:</span>
                                <p className='p-0 m-0'>123</p>
                            </div>
                            <div className='list-details-card pb-2 d-flex align-items-center gap-3 w-100'>
                                <p className='p-0 m-0'>City</p>
                                <span className='p-0 m-0'>:</span>
