        ...
        <div className='form-box bg-white radius-12 p-20'>
            <div className='row'>
                <div className='col-lg-3 col-md-6 mb-4'>
                    <FloatingLabel controlId="floatingInput" label="Company Name" className="mb-md-0 filled-box filled-bg">
                        <Form.Control type="text" placeholder="John" defaultValue="John Investigations"/>
                    </FloatingLabel>
                </div>
                <div className='col-lg-3 col-md-6 mb-4'>
                ...
                <div className='col-md-6 mb-4'>
                        <FloatingLabel controlId="floatingInput" label="Company Address" className="mb-md-0 filled-box filled-bg">
                ...
                <div className='col-lg-3 col-md-6 mb-lg-0 mb-4'>
                    <FloatingLabel controlId="floatingSelect" label="State/Provenance">
                        <Form.Select aria-label="State/Provenance">
                            <option>Taxus</option>
                ...
                <div className='col-lg-3 col-md-6 mb-lg-0 mb-0'>
                    <FloatingLabel controlId="floatingInput" label="Company Website" className="mb-md-0 filled-box filled-bg">
                        <Form.Control type="text" placeholder="John" defaultValue="https://johninvestigations.com"/>
                    </FloatingLabel>
                </div>
            </div>
        </div>
