...
import ChildCreateSubUser from '../../modalComponent/ChildCreateSubUser';

const ChildUserFilter = () => {
  ...
  return (
    <div className='fice-col-box'>
            <div className="header-list-box p-0 mb-2 border-0 radius-0">
                <ul className="p-0 pb-2 min-w-900 m-0 list-unstyled d-flex radius-0  flex-wrap">
                    ...
                    <li>
                        <Form.Group className="form-group position-relative select-with-text" controlId="exampleForm.ControlTextarea1">
                            <span className="option-in-select">Company : </span>
                    ...
                    <li>
                        <button onClick={handleCreateSubUser} className="small-btn-outline btn-outline fill-btn d-flex align-items-center gap-2 text-nowrap flex-nowrap justify-content-center">
              ...
              <ChildCreateSubUser show={showCreateSubUser} handleClose={handleCloseAll} />              
            {/* <CreateSubUser show={showSubUser} handleClose={handleCloseAll} /> */}
        </div>
  )
}

export default ChildUserFilter