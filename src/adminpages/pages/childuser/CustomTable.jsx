                ...
                <Table className="text-center table-hover align-middle m-0 p-0" responsive>
                    ...
                    <tbody>
                        <tr>
                            <td>
                                <div className='author-name d-flex align-items-center gap-2'>
                                    ...
                                    <div>
                                        ...
                                        <div className='email'>sandeep.p@cisinlabs.com</div>
                                    </div>
                            ...
                            <td>
                                <div className='text-start'>
                                    <p className="mb-0">Sandeep Pateria</p>
                        ...
                        <tr>
                            ...
                            <td>05/05/2026</td>
                            <td>
                                <Form.Check type="switch" id="custom-switch-9" label={userStatus.user9 ? "Active" : "Disabled"} className="switch-btn switch-active-disactive m-auto justify-content-center" checked={userStatus.user9} onChange={() => setUserStatus({ ...userStatus, user9: !userStatus.user9, })} />
                            </td>
                            <td>
                                <ul className='d-flex p-0 m-0 align-items-center gap-3 list-unstyled justify-content-center'>
                                    <li>
                        ...
                        <tr>
                            ...
                            <td>05/05/2026</td>
                            <td>
                                <Form.Check type="switch" id="custom-switch-10" label={userStatus.user10 ? "Active" : "Disabled"} className="switch-btn switch-active-disactive m-auto justify-content-center" checked={userStatus.user10} onChange={() => setUserStatus({ ...userStatus, user10: !userStatus.user10, })} />
                            </td>
                            <td>
                                <ul className='d-flex p-0 m-0 align-items-center gap-3 list-unstyled justify-content-center'>
                                    <li>
