...
const ChildCreateSubUser = ({ show, handleClose }) => {
  ...
  return (
    ...
    <Modal show={show} onHide={handleClose} centered className="common-modal sm-modal pt-lg-4 pt-5">
      ...
      <Modal.Body className="common-modal-body">
        <Tab.Container id="left-tabs-example" defaultActiveKey="first">
          <div className="modal-inner-content">
            <h5 className="p-0 m-0 mb-1">Create Sub User</h5>
            <p>Create a child user under the company user...</p>
              <div className='form-box mt-4'>
                <div className='row'>
                  <div className='col-md-12 mb-4'>
                      <FloatingLabel controlId="floatingSelect" label="Select Main User">
                          <Form.Select aria-label="Floating label select example">
                              <option>12345 - Xyz intercom co.</option>
                              <option value="1">12345 - Xyz intercom co.</option>
                          </Form.Select>
                      </FloatingLabel>
                  </div>
                  <div className='col-md-12'>
                    <FloatingLabel controlId="floatingInput" label="User Name" className="mb-4 filled-box filled-bg">
                      <Form.Control type="text" placeholder="User Name" defaultValue="johnsmith@xyz.com" />
                    </FloatingLabel>
                  </div>

                  <div className='col-md-12'>
                    <FloatingLabel controlId="floatingInput" label="Email" className="mb-4 filled-box filled-bg">
                      <Form.Control type="text" placeholder="username@xyz.com" defaultValue="username@xyz.com" />
                    </FloatingLabel>
                  </div>
      ...
      <Modal.Footer className="border-0 pt-0 p-4 m-0">
        <button className="btn-outline fill-btn w-100 m-0">
          Save User
        </button>
      </Modal.Footer>
    </Modal>
...
export default ChildCreateSubUser