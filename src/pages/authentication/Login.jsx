...
import Banner from '../../assets/images/banner-login-img.png'
import Google from '../../assets/images/google.svg'
import Micro from '../../assets/images/microsoft.svg'
import LogoMobile from '../../assets/images/logo-login-pages.svg'
...
const Login = () => {  
  ...
  return (
    <div className=' auth-wrapper registration-sec'>
        <div className='auth-container'>
            <div className='auth-info  position-relative d-lg-block d-none'>
                <div className='auth-img-info'>
                    <div className='auth-logo'>
                        <img src={Logo} alt="" />
                    </div>
                    <div className='login-text'>
                        <h1>Professional Reporting Business Empowerment</h1>
                        <p>Secure, accurate and compliant reporting solution for modern organization</p>
                    </div>
                </div>
            ...
            <div className='auth-form text-center '>
                <div className='auth-logo d-lg-none d-block'>
                    <img src={LogoMobile} alt="" />
                </div>
                <div className='max-card'>
                    <h2>Welcome Back</h2>
                    <p>Use your credentials to continue accessing your account with CoMVRs.com</p>
                    <div className='form-login-box'>    
                        <FloatingLabel controlId="floatingInput" label="Email" className="mb-4 filled-box filled-bg">
                            <Form.Control type="text" placeholder="email" defaultValue="Johnsmith1001@gmail.com" />
                        </FloatingLabel>
                    ...
                    <div className="forgot-link text-center">
                        <Link to="" className='link-underline-text'>Forgot Password</Link>
                    </div>

                    <Link to="/dashboard" className='btn-outline fill-btn w-100 '>Login</Link>

                    <div className='contineue-box'>
                        <p>or continue with</p>
                    </div>

                    <ul className='social-download p-0 m-0 list-unstyled d-flex flex-wrap gap-md-3 gap-2 justify-content-center'>
                        <li>
                            <Link to="">
                                <img src={Google} alt="" />
                            </Link>
