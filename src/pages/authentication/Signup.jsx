...
import Logo from '../../assets/images/logo-sign-up.svg'
...
const Signup = () => {
  ...
  return (
    <div className='sign-up position-relative'>
      <Link to="" className='back-home d-flex align-items-center gap-2'>
          <svg width="10" height="18" viewBox="0 0 10 18" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M9.42464 15.3301C9.63598 15.5414 9.75471 15.8281 9.75471 16.127C9.75471 16.4258 9.63598 16.7125 9.42464 16.9238C9.21329 17.1352 8.92665 17.2539 8.62776 17.2539C8.32888 17.2539 8.04223 17.1352 7.83089 16.9238L0.330887 9.42383C0.226007 9.31931 0.142791 9.19512 0.0860095 9.05837C0.0292284 8.92163 0 8.77502 0 8.62695C0 8.47889 0.0292284 8.33228 0.0860095 8.19553C0.142791 8.05878 0.226007 7.93459 0.330887 7.83008L7.83089 0.330076C8.04223 0.118732 8.32888 -4.45375e-09 8.62776 0C8.92665 4.45375e-09 9.21329 0.118732 9.42464 0.330077C9.63598 0.541421 9.75471 0.828065 9.75471 1.12695C9.75471 1.42584 9.63598 1.71248 9.42464 1.92383L2.72245 8.62601L9.42464 15.3301Z" fill="currentColor"/></svg>
          <span>Back to Home</span>
      </Link>
      <div className='sign-up-mid'>
          <Link to="" className='logo-box'>
              <img src={Logo} alt="" />
          </Link>
          <div className='sign-up-box'>
              <h4>User Registration</h4>
              <p>Please enter your details to create an account with CoMVRs.com</p>
              <div className='form-box'>
                <div className='row'>
                  <div className='col-md-6'>
                    <FloatingLabel controlId="floatingInput" label="First Name" className="mb-4 filled-box filled-bg">
                      <Form.Control type="text" placeholder="name" defaultValue="John" />
                    </FloatingLabel>
                  </div>
                  <div className='col-md-6'>
                    <FloatingLabel controlId="floatingInput" label="Last Name" className="mb-4 filled-box filled-bg">
                      <Form.Control type="text" placeholder="name" defaultValue="Smith" />
                    </FloatingLabel>
                  </div>
                  <div className='col-md-12'>
                    <FloatingLabel controlId="floatingInput" label="Your Email Address" className="mb-4 filled-box filled-bg">
                  ...
                  <div className='col-md-12 mb-4'>
                      <FloatingLabel controlId="floatingSelect" label="Account Type">
                          <Form.Select aria-label="Floating label select example">
                              ...
                              <option value="1">Privet Investigator (PI)One</option>
                              <option value="2">Privet Investigator (PI)Two</option>
                              <option value="3">Privet Investigator (PI)Three</option>
                          </Form.Select>
                      </FloatingLabel>
                  </div>
                  <div className='col-md-12'>
                  ...
                  <div className='col-md-12'>
                    <Link to="" className='btn-outline fill-btn w-100 '>Sign Me Up</Link>
                     <div className='create-account mt-3'>
                          <p className='m-0 text-cenetr'>Already a user? 
        ...
        <div className='copy-right'>
            <p className='p-0 m-0 pb-4'>@2026, CoMVRs.com all rights reserved.</p>
        </div>
    </div>
  )
}
