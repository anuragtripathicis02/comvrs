...
import EnterRequiredInfo from "./EnterRequiredInfo";
...
useEffect(() => {
  const scrollContainer = document.querySelector(
    ".content-inner-wrapper.custom-layout"
  );
      ...
      <div className="content-area" onScroll={handleScroll}>
        ...
        {!selectedCategory && (
            <div
                ...
                className="details-section active-details"
            >
                <CategorySelection
        ...
        <div
            ...
            className="details-section active-details"
        >
            <ServiceSelection onSelectService={(Service) => {
