  ...
  return (
    <div className='mb-4'>
        <div className="head-box w-100 mb-2">
            <p className="m-0 font-w-600 fs-16">Completed Orders</p>
        </div>
        
        <div className="table-default min-w-1200">
            <Table className="text-center table-hover align-middle m-0 p-0 midius-text-table" responsive>
                <thead>
                    <tr>
                        <th>Order Id</th>
                        <th className='text-start' >Requested Record/Info</th>
