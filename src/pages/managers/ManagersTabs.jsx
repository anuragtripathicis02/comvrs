...
import CreateManager from '../../modalComponent/CreateManager'

const ManagersTabs = () => { // table pagination 
  ...
  return (
    <div className="table-default min-w-1200">
        ...
        <div className="custom-pagination d-flex align-items-center gap-2 pt-3 pb-0 flex-wrap justify-content-between">
            <div className='d-flex align-items-center gap-2 pb-0'>
