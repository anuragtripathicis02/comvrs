...
const EditCardDetailsModal = ({ show, handleClose }) => {
  return (
    <Modal show={show} onHide={handleClose} centered className="common-modal sm-modal pt-lg-4 pt-5">
      ...
      <Modal.Body className="common-modal-body">
        <Tab.Container id="left-tabs-example" defaultActiveKey="first">
          <div className="modal-inner-content">
            <h5 className="mb-4">Edit Card Details</h5> <div className='form-box mt-4'>
              <div className='row'>
                <div className='col-md-12'>
                  <FloatingLabel controlId="floatingInput" label="Credit Card Number" className="mb-4 credit-card filled-box filled-bg posotion-relative">
      ...
      <Modal.Footer className="flex-nowrap m-1 border-0 pt-0">
        <button className="btn-outline grey-btn w-100" onClick={handleClose}>
          Close
        </button>
