...
import InvoiceGeneratedEditCardModal from './InvoiceGeneratedEditCardModal';

const InvoiceGeneratedModal = ({ show, handleClose }) => {
  ...
  return (
    <>
        <Modal show={show} onHide={handleClose} centered className="common-modal sm-modal pt-lg-4 pt-5">
            ...
            <Button variant="link" className="btn-close-btn">
            ...
            <Modal.Footer className="flex-nowrap m-1 border-0 pt-0">
                <button className="w-100 btn-outline grey-btn" onClick={handleClose}>
                    Close
                </button>
                <button className="w-100 btn-outline fill-btn">
                    Pay Now
                </button>
            </Modal.Footer>
        </Modal>
        <InvoiceGeneratedEditCardModal show={showEditCard} handleClose={() => setShowEditCard(false)}/>
    </>
  )
}
