            ...
            <Modal.Body className="common-modal-body">
                <Tab.Container id="left-tabs-example" defaultActiveKey="first">
                    <div className="modal-inner-content">
                        <h5 className="mb-2 m-0 p-0  ">Company Info</h5> 
                        <p className="p-0 m-0 mb-4">Enter your organization details to set up your profile...</p>
                        <div className='mt-2'>
                            <div className='row'>
                                <div className='col-md-12'>
                                    <FloatingLabel controlId="floatingInput" label="Company Name" className="mb-4  filled-box filled-bg">
                                        <Form.Control type="email" placeholder="text" defaultValue="johnsmith@xyz.com" />
                                    </FloatingLabel>
                                </div>
                                <div className='col-md-12'>
                                    <div className="fleg-box mb-4 position-relative floting-box padding-fixed">
                                        <OnlyFlagPhoneInput />
                                    </div>
                                </div>
                                <div className='col-md-12'>
                                    <FloatingLabel controlId="floatingInput" label="Company Address" className="mb-4  filled-box filled-bg">
                                        <Form.Control type="email" placeholder="1234 Main Street, Apt 100, Houston, TX 77002" defaultValue="1234 Main Street, Apt 100" />
                                    </FloatingLabel>
                                </div>
                                ...
                                <div className='col-md-6 mb-4'>
                                    <FloatingLabel controlId="floatingSelect" label="State/Provenance" className=''>
                                        <Form.Select aria-label="Floating label select example">
                                            <option>Taxus</option>
                                ...
                                <div className='col-md-12'>
                                    <FloatingLabel controlId="floatingInput" label="Company Zip Code" className="mb-4 filled-box filled-bg ">
                                        <Form.Control type="text" placeholder="123456" defaultValue="Company Zip Code" />
                                    </FloatingLabel>
                                </div>
                                <div className='col-md-12'>
                                    <Form.Group controlId="formFile2" className="mb-0 position-relative upload-input-box floating-upload-input-box form-group">
